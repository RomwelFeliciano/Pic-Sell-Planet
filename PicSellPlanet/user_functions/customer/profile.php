		...
		<div class="container py-2 px-1">
			<div class="col-lg-10 offset-md-1">
				<div class="row">
					...
					$is_liked =  $conn->query("SELECT * FROM tbl_post_likes p LEFT JOIN tbl_user_account u ON p.user_id = u.user_id where u.user_archive_status = 1 AND p.user_id = {$_SESSION['login_user_id']} and p.post_id = {$row['post_id']} ")->num_rows ? "text-danger" : "";
