			...
			<div class="center-panel py-2 px-2">
				<div class="container-fluid">
					...
					<div class="card-footer card-comments">
						<?php 
							$comment_num = $conn->query("SELECT COUNT(*) as total FROM tbl_post_comments c LEFT JOIN tbl_user_account u ON c.user_id = u.user_id WHERE u.user_archive_status = 1 AND c.post_id = {$row['post_id']}")->fetch_assoc();
